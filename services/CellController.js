...
class CellController {
  ...
  */
  ...
  generateBotOps(playerIds, players, coins) {
    var self = this;
  ...
  applyPlayerOps(playerIds, players, coins) {
    var self = this;
  ...
  findPlayerOverlaps(playerIds, players, coins) {
    var self = this;
